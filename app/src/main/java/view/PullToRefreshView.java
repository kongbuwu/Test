...
public class PullToRefreshView extends LinearLayout {
	...
	private void init() {
		...
		rotata_show = AnimationUtils.loadAnimation(context, R.anim.rotata_show);
...
//		addFooterView();
	...
	public boolean onInterceptTouchEvent(MotionEvent e) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (Math.abs(deltaX) > Math.abs(deltaY)) {// X�ƶ��������Y���� ���Ƹ���view
				return false;
			}
...
//				footerPrepareToRefresh(deltaY);
			...
			break;
		case MotionEvent.ACTION_UP:
			if((mPullState == PULL_UP_STATE)&&!enablePullLoadMoreDataStatus){
...
//					footerRefreshing();
	...
	private void headerPrepareToRefresh(int deltaY) {
		...
		mHeaderImageView.setRotation(newTopMargin*3);
...
//			mHeaderImageView.startAnimation(mFlipAnimation);
	...
	private void footerPrepareToRefresh(int deltaY) {
		int newTopMargin = changingHeaderViewTopMargin(deltaY);
		mFooterImageView.setRotation(newTopMargin*3);
...
//		mHeaderImageView.setImageDrawable(null);
		mHeaderImageView.startAnimation(rotata_show);
...
//		mFooterImageView.setImageDrawable(null);
		mFooterImageView.startAnimation(rotata_show);
//		mFooterProgressBar.setVisibility(View.VISIBLE);
	...
	public void onHeaderRefreshComplete() {
		...
		mHeaderImageView.setImageResource(R.mipmap.img_circulation);
		mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
//		mHeaderProgressBar.setVisibility(View.GONE);
	...
	public void onFooterRefreshComplete() {
		...
		mFooterImageView.setImageResource(R.mipmap.img_circulation);
		mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
