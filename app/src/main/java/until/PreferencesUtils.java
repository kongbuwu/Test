...
public class PreferencesUtils {
	...
	public static String  TokenXMPP="tokenxmpp";
	
	
	
	public static String getSharePreStr(Context mContext,String field){
		SharedPreferences sp=(SharedPreferences) mContext.getSharedPreferences(QQXMPP, 0);
		String s=sp.getString(field,"");//如果该字段没对应值，则取出字符串0
		return s;
	}
	public static String getSharePreStr2(Context mContext,String field){
		SharedPreferences sp=(SharedPreferences) mContext.getSharedPreferences(TokenXMPP, 0);
		String s=sp.getString(field,"");//如果该字段没对应值，则取出字符串0
		return s;
	}
	...
	public static int getSharePreInt2(Context mContext,String field){
		SharedPreferences sp=(SharedPreferences) mContext.getSharedPreferences(TokenXMPP, 0);
		int i=sp.getInt(field,0);//如果该字段没对应值，则取出0
		return i;
	}
	...
	public static boolean getSharePreBoolean2(Context mContext,String field){
		SharedPreferences sp=(SharedPreferences) mContext.getSharedPreferences(TokenXMPP, 0);
		boolean i=sp.getBoolean(field, false);//如果该字段没对应值，则取出0
		return i;
	}
	...
	public static void putSharePre2(Context mContext,String field,String value){
		SharedPreferences sp=(SharedPreferences) mContext.getSharedPreferences(TokenXMPP, 0);
		sp.edit().putString(field, value).commit();
	}
	...
	//清空保存的数据
		...
		public static void clearSharePre2(Context mContext){
			try {
				SharedPreferences sp=(SharedPreferences) mContext.getSharedPreferences(TokenXMPP, 0);
				sp.edit().clear().commit();
			} catch (Exception e) {
